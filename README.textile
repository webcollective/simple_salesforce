...
h2. SimpleSalesforce is no longer being maintained; you should use the new "DatabaseDotCom":https://github.com/heroku/databasedotcom gem from Heroku instead.
